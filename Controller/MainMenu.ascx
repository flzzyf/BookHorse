<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MainMenu.ascx.cs" Inherits="Controller_MainMenu" %>

<asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/Web/MainWeb.aspx">主界面</asp:HyperLink>
<asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/Web/Admin/BookAdd.aspx">添加新书</asp:HyperLink>
